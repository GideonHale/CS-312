...
# to be displayed.
	...
	def compute_hull( self, points, pause, view):
		...
		# self.showPoints(hullPoints, YELLOW, "Finished!")
	...
	def findHull(self, points):
		# self.showPoints(points, BLUE, "showing initial dataset")
		...
		# self.showPoints(lPoints, BLUE, "showing sorted lPoints, rightmostIndex: " + str(rightmostLPointIndex))
		rPoints, rightmostRPointIndex = self.findHull(rPoints)
		# self.showPoints(rPoints, BLUE, "showing sorted rPoints, rightmostIndex: " + str(rightmostRPointIndex))

		# self.showHull(self.pointsToLines(lPoints), PURPLE)
		# self.showHull(self.pointsToLines(rPoints), PURPLE)
		...
		# self.showPoints([lPoints[UL], rPoints[UR]], GREEN, "upper tangent")
		# self.showPoints([lPoints[LL], rPoints[LR]], GREEN, "lower tangent")
		
		# self.eraseHull(self.pointsToLines(lPoints))
		# self.eraseHull(self.pointsToLines(rPoints))
	...
	def upperTangent(self, lPoints, rPoints, rightmostLPointIndex):
		...
		# self.showPoints([lPoint, rPoint], RED, "current upper tangent line")
	...
	def lowerTangent(self, lPoints, rPoints, rightmostLPointIndex):
		...
		# self.showPoints([lPoint, rPoint], RED, "current lower tangent line")
